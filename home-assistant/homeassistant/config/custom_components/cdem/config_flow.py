...
async def validate_input(hass: HomeAssistant, data: dict) -> dict[str, Any]:
    ...
    # This is a simple example to show an error in the UI for a short devicename
    ...
    async def async_step_user(self, user_input=None):
        ...
        if user_input is not None:
            try:
                ...
                errors["name"] = "Invalid device name"
...
class InvalidDeviceName(exceptions.HomeAssistantError):
    """Error to indicate there is an invalid devicename."""
