...
#    async_add_entities(HelloWorldCover(cdem))
#
#
...
#        self._attr_unique_id = f"{self._cdem.cdem_id}_cover"
#
#        # This is the name for this *entity*, the "name" attribute from "device_info"
#        # is used as the device name for device screens in the UI. This name is used on
#        # entity screens, and used to build the Entity ID that's used is automations etc.
#        self._attr_name = self._cdem.name
#
...
#        return self._cdem.position
#
#    @property
#    def is_closed(self) -> bool:
#        """Return if the cover is closed, same as position 0."""
#        return self._cdem.position == 0
#
#    @property
#    def is_closing(self) -> bool:
#        """Return if the cover is closing or not."""
#        return self._cdem.moving < 0
#
#    @property
...
#        """Open the cover."""
#        await self._cdem.set_position(100)
#
#    async def async_close_cover(self, **kwargs: Any) -> None:
#        """Close the cover."""
#        await self._cdem.set_position(0)
#
#    async def async_set_cover_position(self, **kwargs: Any) -> None:
#        """Close the cover."""
#        await self._cdem.set_position(kwargs[ATTR_POSITION])
